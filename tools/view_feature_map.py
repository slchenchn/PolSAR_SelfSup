...
def view_feature_map(backbone_cfg, pth_name, img_path, video_dir='tmp', fram_size=(512, 512)):
    ...
    target = c5
    videoPath = osp.join(video_dir, f'{pth_name}_c5.mp4')
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')
    videoWriter = cv2.VideoWriter(videoPath, fourcc, fps=10, framesize=fram_size)
...
if __name__ == '__main__':
    ...
    pth_name = 'pbyolv5_r50-d8-pretrained_sn6_sar_pro_ul_fh_v2_ep200_lars_lr02_bs256/20211117_220056/mmseg_epoch_200'
    img_path = 'data/SN6_sup/SAR-PRO_rotated/SN6_Train_AOI_11_Rotterdam_SAR-Intensity_20190804111224_20190804111453_tile_8679.tif'
    video_dir = 'tmp'
